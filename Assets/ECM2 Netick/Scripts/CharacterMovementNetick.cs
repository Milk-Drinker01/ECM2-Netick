...
namespace ECM2
{
    ...
    public sealed class CharacterMovementNetick : MonoBehaviour
    {
        public PhysicsScene SandboxPhysicsScene;
        ...
        private void ResolveOverlaps(DepenetrationBehaviour depenetrationBehaviour = DepenetrationBehaviour.IgnoreNone)
        {
            ...
            for (int i = 0; i < _advanced.maxDepenetrationIterations; i++)
            {
                ...
                int overlapCount = SandboxPhysicsScene.OverlapCapsule(bottom, top, _radius, _overlaps, _collisionLayers, triggerInteraction);
                if (overlapCount == 0)
                    break;
            ...
            float testHeight, int layerMask, Collider[] results, QueryTriggerInteraction queryTriggerInteraction)
        {
            ...
            int rawOverlapCount =
                SandboxPhysicsScene.OverlapCapsule(bottom, top, testRadius, results, layerMask, queryTriggerInteraction);
            ...
            float thickness = 0.0f)
        {
            ...
            int rawHitCount = thickness == 0.0f
                ? SandboxPhysicsScene.Raycast(origin, direction, _hits, distance, layerMask, triggerInteraction)
                : SandboxPhysicsScene.SphereCast(origin - direction * thickness, thickness, direction, _hits, distance, layerMask, triggerInteraction);
            ...
            int layerMask, out RaycastHit hitResult, out bool startPenetrating)
        {
            ...
            int rawHitCount = SandboxPhysicsScene.CapsuleCast(bottom, top, castRadius, castDirection, _hits, castDistance,
            ...
            out RaycastHit hitResult, out bool startPenetrating, out Vector3 recoverDirection, out float recoverDistance, bool ignoreNonBlockingOverlaps = false)
        {
            ...
            int rawHitCount =
                SandboxPhysicsScene.CapsuleCast(bottom, top, castRadius, castDirection, _hits, castDistance, layerMask, triggerInteraction);
            ...
            float castDistance, int castLayerMask, out RaycastHit hitResult, out bool startPenetrating)
        {
            ...
            int rawHitCount = SandboxPhysicsScene.CapsuleCast(point1, point2, castRadius, castDirection, _hits,
            ...
            float castDistance, int castLayerMask, out RaycastHit hitResult, out bool startPenetrating)
        {
            ...
            int rawHitCount = SandboxPhysicsScene.BoxCast(center, halfExtents, castDirection, _hits, orientation,
                castDistance, castLayerMask, triggerInteraction);
